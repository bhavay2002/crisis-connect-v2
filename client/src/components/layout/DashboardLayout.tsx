...
const menuItems = [
  ...
  { title: "Intelligence", url: "/intelligence", icon: Sparkles, roles: ["admin", "government"] },
  { title: "AI Copilot", url: "/copilot", icon: Zap, roles: ["citizen", "volunteer", "ngo", "admin", "government"] },
  { title: "Risk Map", url: "/risk-map", icon: Shield, roles: ["volunteer", "ngo", "admin", "government"] },
  { title: "Broadcast Alerts", url: "/broadcast-alerts", icon: Bell, roles: ["ngo", "admin"] },
  { title: "Trust & Fraud", url: "/trust", icon: Shield, roles: ["admin"] },
